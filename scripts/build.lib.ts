...
const { internal } = collectImportsSync(resolve(__dirname, '../src/index.ts'));
...
fs.copySync(resolve(src, 'utils/ws.ts'), resolve(lib, 'utils/ws.ts'));